 ...
 * Created by zhu on 12/20/15.
 */
public class ColorArcProgressBar_old extends View{
    ...
    public ColorArcProgressBar_old(Context context) {
        super(context, null);
        initView();
    }


    public ColorArcProgressBar_old(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        initCofig(context, attrs);
        initView();
    }

    public ColorArcProgressBar_old(Context context, AttributeSet attrs, int defStyleAttr) {
